                ...
                <body className="bg-gray-50 font-sans m-0 p-0 w-full py-4">
                    <Card>
                        <h1 className="text-gray-900 text-2xl font-bold mt-0 mb-6 text-left">
                            Prêt à reprendre votre recherche d'
                            <span className="text-[#02153A]">investissements</span> ? 🚀
                        </h1>

                        <p className="text-gray-700 text-base mb-4">Salut {name},</p>

                        <p className="text-gray-700 text-base mb-5">
                            Cela fait un petit moment que vous n'êtes pas passé par Cash Flow Radar.
                            Nous espérons que tout va bien de votre côté !
                        </p>

                        <p className="text-gray-700 text-base mb-5">
                            Les opportunités immobilières n'attendent pas, et nous avons encore
                            beaucoup de biens intéressants qui pourraient correspondre à vos
                            critères. Il est temps de reprendre le contrôle et de relancer vos
                            recherches !
                        </p>
